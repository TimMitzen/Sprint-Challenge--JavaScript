...
//   universities.sort();
// }
graduates.map(uni => uni.university);
universities.sort();
...
//   }
// }
graduates.map(university => university.university).filter(university => university.includes("Uni"));;



console.log(uni);
//graduates.forEach(university => uni.push(if(graduates[i].university.includes("Uni"))
